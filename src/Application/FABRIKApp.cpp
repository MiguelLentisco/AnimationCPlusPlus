...
void FABRIKApp::Update(float inDeltaTime)
{
...
void FABRIKApp::Render(float inAspectRatio)
{
...
void FABRIKApp::SetFrame(VectorTrack& track, int index, float time, const Vec3& value)
{
